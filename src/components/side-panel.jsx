...
function SidePanel({ className }) {
  ...
  return (
    <div className={`${className} p-6 whitespace-nowrap overflow-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']`}>
      <div className="pb-3 text-xl font-semibold">Shapes</div>
      ...
      <div className="grid grid-cols-1 gap-2 xl:grid-cols-2">
        ...
        >
          <div className="relative flex h-10 w-10 flex-col items-center justify-center space-y-0 border border-black p-1 text-xs text-black">
            ...
            <p className="leading-none">BTS</p>
            <p className="leading-none">side</p>
          </div>
          <h2 className="text-sm">From BTS</h2>
        </div>
        <div
          className="flex flex-col items-center justify-center space-y-1 rounded-lg border border-neutral-400 p-2 duration-300 hover:bg-white"
